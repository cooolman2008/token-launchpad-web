...
function Links({ type }: { type: number }) {
	...
	return (
		<>
			...
			<a href="https://safu-1.gitbook.io/safu-launcher" className={linkClass} target="_blank">
				<span className="">Docs</span>
			</a>
			<a href="www.google.com" className={linkClass + " flex group"}>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24px"
					height="24px"
					viewBox="0 0 24 24"
					className={"mr-1 group-hover:fill-slate-200 " + (type === 2 ? "fill-slate-200" : "fill-gray-400")}
				>
