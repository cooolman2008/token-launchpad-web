...
import stack from "../../../../public/gov.png";
import liqlock from "../../../../public/liqlock.jpg";
import token from "../../../../public/tokens.png";
		...
		<>
			...
			>
				...
				<div className="pt-6 pb-8 lg:px-10">
					...
					<p className="max-lg:w-96 max-lg:mx-auto text-md lg:text-lg font-thin text-gray-400">{desc}</p>
				</div>
			</div>
		</>
	);
